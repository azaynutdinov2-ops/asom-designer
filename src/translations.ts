...
export const translations = {
  uz: {
    ...
    heroTrustSignal: "Arizangiz 1-soniyada qabul qilinadi va mentor bilan bog'lanasiz",
    ...
    ctaSub: "Joylar soni chegaralangan. Ismingiz va telefon raqamingizni kiriting — arizangiz to'g'ridan-to'g'ri qabul qilinadi!",
    ctaRegisterBtn: "Telegram Orqali Zudlik Bilan A'zo Bo'lish",
    ctaConsultTitle: "To'g'ridan-To'g'ri Ariza Yuborish",
    ctaConsultSub: "Ortiqcha anketalarsiz — faqat ismingiz va telefoningizni kiriting.",
    ctaNameLabel: "Ismingiz:",
    ctaNamePlaceholder: "Masalan: Jasur Rahimov",
    ctaPhoneLabel: "Telefon Raqamingiz:",
    ctaSubmitBtn: "Arizani Yuborish (1-Soniyada)",
    ctaSuccess: "Arizangiz Qabul Qilindi! 🎉",
    ctaSuccessSub: "Rahmat! Ma'lumotlaringiz saqlandi va mentor Asom Designer siz bilan tez orada bog'lanadi.",
    ctaOpenTelegram: "Telegram'da Mentorga Yozish",
    ctaCallNow: "Qo'ng'iroq Qilish",
    phone: "Telefon",
    telegram: "Telegram",
    youtube: "YouTube",
    phoneLabel: "Telefon:",
  ...
  ru: {
    ...
    ctaSub: "Количество мест ограничено. Введите ваше имя и телефон — ваша заявка мгновенно принимается!",
    ctaRegisterBtn: "Записаться напрямую в Telegram",
    ctaConsultTitle: "Прямая Подача Заявки",
    ctaConsultSub: "Без лишних анкет — просто укажите ваше имя и номер телефона.",
    ctaNameLabel: "Ваше Имя:",
    ctaNamePlaceholder: "Например: Иван Иванов",
    ctaPhoneLabel: "Ваш Номер Телефона:",
    ctaSubmitBtn: "Отправить Заявку (За 1 секундy)",
    ctaSuccess: "Заявка Принята! 🎉",
    ctaSuccessSub: "Спасибо! Ваши данные сохранены. Ментор Asom Designer свяжется с вами в ближайшее время.",
    ctaOpenTelegram: "Написать ментору в Telegram",
  ...
  en: {
    ...
    heroTrustSignal: "Direct instant application accepted in 1 second",
    ...
    ctaSub: "Limited seats available. Enter your name and phone number — your application is accepted directly!",
    ctaRegisterBtn: "Direct Enrollment via Telegram",
    ctaConsultTitle: "Direct Instant Application",
    ctaConsultSub: "No long forms — just enter your name and phone number.",
    ctaNameLabel: "Your Name:",
    ctaNamePlaceholder: "e.g., Alex Morgan",
    ctaPhoneLabel: "Your Phone Number:",
    ctaSubmitBtn: "Submit Application (1-Sec)",
    ctaSuccess: "Application Received! 🎉",
    ctaSuccessSub: "Thank you! Your details have been saved and mentor Asom Designer will contact you shortly.",
    ctaOpenTelegram: "Message Mentor on Telegram",
    ctaCallNow: "Call Now",
    phone: "Phone",
    telegram: "Telegram",
    youtube: "YouTube",
